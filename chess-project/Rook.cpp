...
Rook::Rook(sf::Texture pieceTexture, std::shared_ptr<Square> currentSquare, bool color)
{
	this->isWhite = color;
...
std::vector<std::shared_ptr<Square>> Rook::PossibleMoves(std::vector<std::vector<std::shared_ptr<Square>>> squares)
{
...
std::vector<std::shared_ptr<Square>> Rook::PossibleTakes(std::vector<std::vector<std::shared_ptr<Square>>> squares)
{
